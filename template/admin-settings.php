...
<link rel="icon" href="images/Apesech.png">
<body style="background-image:url(img/deviantart.jpg)">
<?php
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="index.php"><i class="icon-home"> Home</a></i>
  <a href="OrderFoodss.php"><i class="icon-shopping-cart"> Food Orders</a></i>
  <a href="Reservation.php"><i class="icon-table"> Reservation</a></i>
  <a href="admin-settings.php"><i class="icon-user"> User Manager</a></i>
  <a href="MyReport.php"><i class="icon-file-alt"> My Report</a></i>
  <a href="index2.php"><i class="icon-group"> Give Report</a></i>
</div>
...
<div class="container-fluid">
      <div class="row-fluid">
		...
		<div class="contentheader" style="color:aliceblue; ">
            <a class="brand" style="cursor:pointer" onclick="openNav()"><b>&#9776; <i class="icon-user icon-small"></i> User </b></a>
          </div>
			<ul class="breadcrumb">
...
<?php 
			...
			<div style="text-align:center;"><h1>
                Total Number of Users: <font color="red" style="font:bold 30px 'Aleo';"><?php echo $rowcount;?></font></h1>
			</div>
</div>
