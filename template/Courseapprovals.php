...
<input type="text" name="filter" style="height:35px; color:#222;" id="filter" placeholder="Search Courses" autocomplete="off" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['csemeseter']; ?></td>


			<td><a  title="Click To Edit Stock Report" rel="facebox" href="notificationindex.php"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Send enrollment key </button></a> 
