...
<a rel="facebox" href="addprovide.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Student Report</button></a><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM provide ORDER BY id DESC");
				$result->execute();
			...
			<td><?php echo $row['assiment']; ?></td>
			<td><?php echo $row['note']; ?></td>
			<td><?php echo $row['date']; ?></td>

			<td><a  title="Click To Edit Stock Report" rel="facebox" href="editprovide.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a> 
