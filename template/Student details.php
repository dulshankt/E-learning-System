                                    ...
                                    <div class="header-search" id="header-search">
                                        <form action="#">
                                            <div class="input-group">
                                                <input type="text"  class="form-control" id="filter" placeholder="Search" autocomplete="off" />
...
<?php 
			...
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM student ORDER BY studentid DESC");
				$result->execute();
				$rowcount = $result->rowcount();
				
			?>
			<div style="text-align:center;">
			Total Number of Student details <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
<a rel="facebox" href="addStockReport.html"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Student Report</button></a><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['sfaculty']; ?></td>
			<td><?php echo $row['sbirthday']; ?></td>

			<td><a  title="Click To Edit Stock Report" rel="facebox" href="editstockreport.php?id=<?php echo $row['studentid']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a> 
			<a href="#" id="<?php echo $row['studentid']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Delete</button></a></td>
			</tr>
			<?php
				}
